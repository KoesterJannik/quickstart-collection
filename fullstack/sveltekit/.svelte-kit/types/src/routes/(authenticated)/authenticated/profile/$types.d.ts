...
type RouteParams = {  };
type RouteId = '/(authenticated)/authenticated/profile';
...
type ActionsExport = typeof import('../../../../../../../src/routes/(authenticated)/authenticated/profile/+page.server.js').actions
